...
slapApp.factory('phonegapReady', function() {
    return function (fn) {
        var queue = [];
        var impl = function () {
...
slapApp.factory('geolocation', function ($rootScope, phonegapReady) {
  return {
...
slapApp.factory('accelerometer', function ($rootScope, phonegapReady) {
    return {
...
slapApp.factory('notification', function ($rootScope, phonegapReady) {
    return {
...
slapApp.factory('compass', function ($rootScope, phonegapReady) {
    return {
...
slapApp.factory('contacts', function ($rootScope, phonegapReady) {
    return {
